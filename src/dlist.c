...
void dlist_destroy(DList *list)
{
    ...
    /* No operations are allowed now, but clear the structure as
     * precaution. 
     */
...
int dlist_ins_next(DList *list, DListElmt *element, const void *data)
{
    ...
    /* Adjust the size of the list to account for the inserted
     * element.
     */
    list->size++;
    return 0;
...
int dlist_remove(DList *list, DListElmt *element, void **data)
{
    ...
    *data = element->data;
    ...
    /* Adjust the size of the list to account for the removed
     * element.
     */
    list->size--;
